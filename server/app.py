...
async def orchestrate(req: OrchestrateRequest, request: Request):
    ...
    # Resolve subscription tier from header or env.
    ...
    # Check monthly quota BEFORE running.
    ...
    # Apply tier-appropriate model mix.
...
async def usage(session_id: str = "web"):
    """Return monthly usage counters for a session."""
...
@app.get("/api/tiers")
async def tiers():
    """Return all available subscription tiers and their quotas."""
